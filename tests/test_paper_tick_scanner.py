# tests/test_paper_tick_scanner.py
"""
Unit tests for PaperExchange tick scanner ordering and gap scenarios.
...
def _make_exchange(balance: float = 10_000) -> PaperExchange:
    cfg = {
        "bot": {"mode": "sim"},
        "paper_sim": {"initial_balance": balance, "telegram_token": ""},
        "risk": {"leverage": 10},
    }
...
def _open_position(ex: PaperExchange, symbol="BTC/USDT", amount="0.03", entry="100000"):
