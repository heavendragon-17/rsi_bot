...
class TestTPBehavior(unittest.TestCase):
    def setUp(self):
        ...
        self.exchange.update_candle("BTC/USDT", Decimal("100"), Decimal("100"), Decimal("100"), Decimal("100"), datetime.now())
    ...
    def test_weird_precision_behavior(self):
        ...
        self.exchange.update_candle("BTC/USDT", Decimal("0.12345"), Decimal("0.12345"), Decimal("0.12345"), Decimal("0.12345"), datetime.now())
    ...
    def test_tp1_retrigger_prevention(self):
        ...
        # Trigger TP1 Once
        signal = SignalEvent(
            symbol="BTC/USDT", signal_type="SELL", price=Decimal("110"),
            reason="TP1 hit", timestamp=datetime.now(), sl_price=Decimal("100")
        )
        self.pm.on_signal(signal)
