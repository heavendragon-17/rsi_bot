...
import { SettingsModal } from "../theme/SettingsModal";
    ...
    <nav className="fixed top-2 sm:top-4 left-2 sm:left-4 right-2 sm:right-4 h-14 z-50 rounded-xl bg-bg-surface/80 backdrop-blur-md border border-bg-elevated/50 shadow-sm flex items-center justify-between px-3 sm:px-4 transition-all duration-300">
      ...
      <div className="flex items-center gap-1 sm:gap-2">
        ...
        <button
          ...
          className="flex p-2 rounded-md text-text-secondary hover:text-text-primary hover:bg-bg-elevated transition-colors items-center justify-center cursor-pointer min-h-[44px] min-w-[44px]"
        >
          <Settings size={18} />
        </button>
      </div>
