...
| [backtest-engine.md](backtest-engine.md)       | Single backtest flow, batch mode, engine internals, data management, SSE bridge                       | Working on backtest engine (`app/backtest/`, `app/api/`)                  |
