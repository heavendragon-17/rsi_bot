...
| `tests/test_signal_replay.py` | Historical CSV validation, UTC+7 normalization, full-card Markdown output, indicator warmup through the requested start, point-in-time future-row isolation, M5 cooldown, manual-review fields, and repeatable rendering |
