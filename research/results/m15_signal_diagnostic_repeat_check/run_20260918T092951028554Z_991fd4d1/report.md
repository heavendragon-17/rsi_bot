...
Signal funnel over the matched window: `140012` candidate bars → `140012` preparation-ready → `38292` passing all three price gates → `1212` also showing a fresh RSI crossover → `1175` emitted after the one-hour cooldown. `2379` further bars crossed but failed at least one price gate, and `37` gate-and-cross bars were suppressed by the one-hour cooldown.
